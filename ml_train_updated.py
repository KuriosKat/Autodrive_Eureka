...
models = {
    ...
    "rf_model.pkl": RandomForestRegressor(n_estimators=4000, random_state=42),
    "et_model.pkl": ExtraTreesRegressor(n_estimators=1000, random_state=42),
    "gb_model.pkl": GradientBoostingRegressor(n_estimators=1000, learning_rate=0.001, random_state=42)
}
